...
namespace Server.Tools
{
    ...
    public class LogManager
    {
        ...
        /// <summary>
        /// Ghi log kèm exception - tương thích Tmsk.Contract
        /// </summary>
        public static void WriteLog(LogTypes logType, string logMsg, Exception ex)
        {
            WriteLog(logType, logMsg + "\r\n" + ex.ToString());
        }

        /// <summary>
        /// Ghi exception có cache - tương thích Tmsk.Contract LogManager
        /// </summary>
        public static void WriteExceptionUseCache(string exStr)
        {
            WriteException(exStr);
        }
    }
}
