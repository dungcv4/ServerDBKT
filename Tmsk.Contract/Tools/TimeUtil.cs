...
namespace GameServer.Core.Executor
{
    public class TimeUtil
    {
        ...
        // Thay thế Windows kernel32.dll P/Invoke bằng Stopwatch cross-platform
        // [DllImport("kernel32.dll")] - KHÔNG DÙNG trên macOS/Linux
        // extern static bool QueryPerformanceCounter(ref long x);
        // extern static bool QueryPerformanceFrequency(ref long x);
        
        // Sử dụng Stopwatch cross-platform thay thế
        private static Stopwatch _performanceStopwatch = new Stopwatch();
        
        static bool QueryPerformanceCounter(ref long x)
        {
            x = _performanceStopwatch.ElapsedTicks;
            return true;
        }
        
        static bool QueryPerformanceFrequency(ref long x)
        {
            x = Stopwatch.Frequency;
        ...
        /// </summary>
        /// <returns></returns>
        // Thay thế winmm.dll P/Invoke bằng cross-platform
        // [DllImport("winmm.dll")] - KHÔNG DÙNG trên macOS/Linux
        // public static extern uint timeGetTime();
        /// <summary>
        /// Thời gian trôi qua kể từ khi server khởi động (ms) - cross-platform
        /// </summary>
