    ...
    public partial class GuildManager
    {
        ...
        public bool CreateDatabaseGuild(string GuildName, int RoleID, int ZoneID, string FamilySTR)
        {
            ...
            try
            {
                ...
                string cmdText = "Insert into t_guild(GuildName,MoneyBound,MoneyStore,ZoneID,Notify,TotalTerritory,MaxWithDraw,Leader,DateCreate,MoneyBuild,FamilyMember) VALUES ('" + GuildName + "',0,1000000," + ZoneID + ",'" + Notify + "',0,50," + RoleID + ",now(),0,'" + FamilySTR + "')";
